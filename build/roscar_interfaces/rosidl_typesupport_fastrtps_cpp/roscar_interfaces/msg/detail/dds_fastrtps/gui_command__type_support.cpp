...
#include "roscar_interfaces/msg/detail/gui_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roscar_interfaces::msg::GuiCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roscar_interfaces::msg::GuiCommand & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roscar_interfaces::msg::GuiCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_roscar_interfaces
max_serialized_size_key_GuiCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const roscar_interfaces::msg::GuiCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roscar_interfaces::msg::GuiCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_roscar_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<roscar_interfaces::msg::GuiCommand>()
{
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_GuiCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roscar_interfaces, msg, GuiCommand)() {
  return &roscar_interfaces::msg::typesupport_fastrtps_cpp::_GuiCommand__handle;
}
